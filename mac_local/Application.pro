...
ios {
        ...
        scripts_dir.files = $$PWD/mobileData/scripts
        ...
        QMAKE_BUNDLE_DATA += data_dir landscapes_dir nebulae_dir skycultures_dir stars_dir textures_dir translations_dir app_launch_images scripts_dir
