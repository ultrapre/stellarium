	...
	, stelGui(Q_NULLPTR)
{
	...
	buttonBar = new BottomStelBar(this,
                      StelGui::ScaledPixmap(QPixmap(":/graphicGui/btbg-left.png")),
                      StelGui::ScaledPixmap(QPixmap(":/graphicGui/btbg-right.png")),
                      StelGui::ScaledPixmap(QPixmap(":/graphicGui/btbg-middle.png")),
                      StelGui::ScaledPixmap(QPixmap(":/graphicGui/btbg-single.png")));
